...
export const metadata: Metadata = {
  title: 'About & Resume',
  description: 'Learn about my journey in web development, my passion for Next.js and SEO, and download my resume.',
}

const skills = [
  {
    category: "Full Stack Development",
    items: ["Next.js", "React", "TypeScript", "Tailwind CSS", "HTML/CSS", "JavaScript", "PostgreSQL", "Node.js/Express.js"],
    gradient: "from-blue-500/20 to-cyan-500/20"
  },
  {
    category: "SEO & Performance",
    items: ["Core Web Vitals", "Technical SEO", "PageSpeed Optimization", "Structured Data", "Analytics"],
    gradient: "from-purple-500/20 to-pink-500/20"
  },
  {
    category: "Tools & Technologies",
    items: ["Git", "Vercel", "Framer Motion", "Lucide Icons", "Neon Postgres", "Cloudinary", "AI Integration"],
...
export default function About() {
  return (
    <>
      <div className="min-h-screen bg-slate-900 relative overflow-hidden py-25">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                {[
                  ...
                  },
                  {
                    ...
                    content: "I'm also AI-literate and leverage artificial intelligence to enhance my productivity and deliver high-quality projects efficiently. This allows me to tackle complex challenges and deliver exceptional results in shorter timeframes.",
              ...
              <div className="relative bg-linear-to-r from-blue-600/20 to-purple-600/20 rounded-3xl backdrop-blur-sm border border-white/10 p-12 max-w-4xl mx-auto overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-gray-300 mb-8 text-xl md:text-2xl font-light font-body max-w-2xl mx-auto">
                    I&apos;m available for full-time remote positions and exciting freelance projects. Let&apos;s create something amazing.
                  </p>
                  <div className="flex flex-col sm:flex-row gap-4 text-[17px] justify-center">
                    <Link
                      href="/contact"
