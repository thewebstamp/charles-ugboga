...
export const metadata: Metadata = {
  title: 'Portfolio',
  description: 'Explore my latest projects showcasing Next.js development, SEO optimization, and modern web technologies.',
}
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-xl md:text-2xl text-gray-300 max-w-2xl mx-auto font-body">
              Explore my featured projects showcasing expertise in Next.js development, 
              e-commerce solutions, and comprehensive SEO optimization.
            </p>
          </div>
          ...
          <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
            <div className="bg-slate-800/40 backdrop-blur-sm rounded-xl p-6 text-center border border-white/10">
            ...
            <div className="bg-slate-800/40 backdrop-blur-sm rounded-xl p-6 text-center border border-white/10">
              <div className="text-3xl font-bold text-transparent bg-linear-to-r from-purple-400 to-pink-400 bg-clip-text">100%</div>
            ...
            <div className="bg-slate-800/40 backdrop-blur-sm rounded-xl p-6 text-center border border-white/10">
              <div className="text-3xl font-bold text-transparent bg-linear-to-r from-green-400 to-cyan-400 bg-clip-text">SEO</div>
              <div className="text-gray-300 mt-2">Optimized</div>
            </div>
          </div>
