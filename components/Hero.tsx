...
export default function Hero() {
  return (
    <section className="min-h-screen flex items-center justify-center bg-linear-to-br from-slate-900 via-blue-900 to-slate-900 relative overflow-hidden py-25">
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12 max-w-7xl mx-auto">
          ...
          >
            <motion.h1 
              className="text-[40px] leading-12 md:text-5xl md:leading-14 lg:text-[62px] lg:leading-18 font-bold mb-6 font-heading"
            ...
            >
              ...
              that drive results and deliver exceptional user experiences.
            </motion.p>
