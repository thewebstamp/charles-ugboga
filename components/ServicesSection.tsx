...
import { Code, Search, Zap, Smartphone, Rocket, BarChart } from 'lucide-react'
...
const services = [
  ...
  },
  {
    ...
    description: "Comprehensive SEO strategies including Core Web Vitals optimization, technical SEO, and content optimization for better rankings.",
    features: ["Core Web Vitals", "Technical SEO", "Structured Data", "Performance"],
  ...
  },
  {
    ...
    description: "Achieving 90+ Lighthouse scores through code splitting, image optimization, and efficient rendering strategies.",
    features: ["Lighthouse 90+", "Image Optimization", "Code Splitting", "Caching"],
  ...
  },
  {
    ...
    description: "Creating beautiful, functional interfaces that work perfectly across all devices and screen sizes.",
    features: ["Mobile First", "Cross-browser", "Accessibility", "UX/UI"],
  ...
  },
  {
    ...
    description: "Quick and reliable deployment on Vercel with CI/CD, automatic optimizations, and global CDN distribution.",
    features: ["Vercel Deployment", "CI/CD", "Global CDN", "Auto Optimizations"],
  ...
  },
  {
    ...
    description: "Implementing comprehensive analytics to track performance, user behavior, and business metrics.",
    features: ["Google Analytics", "Performance Metrics", "User Tracking", "Conversion"],
    ...
    <section className="py-20 bg-slate-900 relative overflow-hidden">
      ...
      <div className="container mx-auto max-w-7xl px-6 relative z-10">
        ...
        >
          ...
          >
            What I <span className="text-gradient bg-linear-to-r from-blue-400 to-purple-400">Offer</span>
          </motion.h2>
          <motion.p
          ...
          >
            Comprehensive web development and SEO services designed to 
          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="relative bg-slate-800/50 backdrop-blur-sm rounded-xl border border-white/10 p-8 group-hover:border-white/20 transition-all duration-300 h-full">
                ...
                {/* Content */}
                <h3 className="text-2xl font-bold text-white mb-4 font-heading group-hover:text-transparent group-hover:bg-linear-to-r group-hover:from-blue-400 group-hover:to-purple-400 group-hover:bg-clip-text transition-all duration-300">
                  {service.title}
                </h3>
                
                <p className="text-gray-300 text-lg font-light mb-6 leading-relaxed font-body">
                  {service.description}
                </p>
                ...
                <ul className="space-y-3">
                  {service.features.map((feature, featureIndex) => (
                    ...
                    >
                      ...
                      <span className="font-body text-[16px]">{feature}</span>
                    </motion.li>
                  ))}
                </ul>
